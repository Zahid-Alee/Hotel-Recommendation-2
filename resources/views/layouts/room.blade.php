            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
              <div class="room-item shadow rounded overflow-hidden">
                <div class="position-relative">
                  ...
                  <small class="position-absolute start-0 top-100 translate-middle-y bg-primary text-white rounded py-1 px-3 ms-4">${hotel.nationality}</small>
                </div>
                <div class="p-4 mt-2">
                  ...
                  <div class="d-flex justify-content-between">
                    <a class="btn btn-sm btn-primary rounded py-2 px-4" target='_blank' href="${hotel.url}">Check Reviews</a>
                    <a class="btn btn-sm btn-dark rounded py-2 px-4" target='_blank' href="${hotel.hotel_url}">Book Now</a>
                  </div>
                </div>
              </div>
            </div>
